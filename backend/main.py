...
def analyze_task(payload: schemas.AnalyzeRequest):
    ...
    1. assignee: The person who is requested or assigned to do the work. If not mentioned or unclear, set to null.
    ...
    3. description: A clear, concise summary of the action/work to be performed.
